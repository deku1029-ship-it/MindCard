...
export class AuthController {
    ...
    init() {
        ...
        document.getElementById('auth-modal-container').innerHTML = getAuthModalHTML();
    ...
    bindEvents() {
        ...
        document.getElementById('close-auth').addEventListener('click', () => this.closeModal());
    ...
    async handleSubmit() {
        ...
        this.submitBtn.innerHTML = '<span class="animate-pulse">Đang xử lý...</span>';
